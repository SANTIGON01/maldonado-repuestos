    ...
    <div className="bg-white border-2 border-maldonado-dark overflow-x-auto">
      <table className="w-full">
        <thead className="bg-maldonado-dark text-white">
          <tr>
            <th className="px-2 sm:px-4 py-3 text-left font-heading">IMAGEN</th>
            <th className="px-2 sm:px-4 py-3 text-left font-heading hidden md:table-cell">CÓDIGO</th>
            <th className="px-2 sm:px-4 py-3 text-left font-heading">NOMBRE</th>
            <th className="px-2 sm:px-4 py-3 text-left font-heading hidden lg:table-cell">CATEGORÍA</th>
            <th className="px-2 sm:px-4 py-3 text-right font-heading hidden sm:table-cell">PRECIO</th>
            <th className="px-2 sm:px-4 py-3 text-center font-heading hidden md:table-cell">STOCK</th>
            <th className="px-2 sm:px-4 py-3 text-center font-heading hidden lg:table-cell">DESTACADO</th>
            <th className="px-2 sm:px-4 py-3 text-center font-heading">ACCIONES</th>
          </tr>
        </thead>
        <tbody>
          {products.map((product, index) => (
            ...
            >
              ...
              <td className="px-2 sm:px-4 py-3 font-mono text-sm hidden md:table-cell">{product.code}</td>
              <td className="px-2 sm:px-4 py-3 font-heading text-sm sm:text-base">{product.name}</td>
              <td className="px-2 sm:px-4 py-3 text-sm hidden lg:table-cell">
                {categories.find((c) => c.id === product.category_id)?.name || '-'}
              </td>
              <td className="px-2 sm:px-4 py-3 text-right font-mono text-maldonado-red font-bold text-sm sm:text-base hidden sm:table-cell">
  ...
  return (
    <div className="bg-white border-2 border-maldonado-dark overflow-x-auto">
      <table className="w-full">
        <thead className="bg-maldonado-dark text-white">
          <tr>
            <th className="px-2 sm:px-4 py-3 text-left font-heading">ICONO</th>
            <th className="px-2 sm:px-4 py-3 text-left font-heading">NOMBRE</th>
            <th className="px-2 sm:px-4 py-3 text-left font-heading hidden md:table-cell">SLUG</th>
            <th className="px-2 sm:px-4 py-3 text-left font-heading hidden lg:table-cell">DESCRIPCIÓN</th>
            <th className="px-2 sm:px-4 py-3 text-center font-heading hidden sm:table-cell">ACTIVA</th>
            <th className="px-2 sm:px-4 py-3 text-center font-heading">ACCIONES</th>
          </tr>
        </thead>
        <tbody>
          {categories.map((category, index) => (
            ...
            >
              ...
              <td className="px-2 sm:px-4 py-3 font-heading text-sm sm:text-base">{category.name}</td>
              <td className="px-2 sm:px-4 py-3 font-mono text-sm text-maldonado-chrome hidden md:table-cell">{category.slug}</td>
              <td className="px-2 sm:px-4 py-3 text-sm truncate max-w-xs hidden lg:table-cell">{category.description || '-'}</td>
  ...
  return (
    <div className="bg-white border-2 border-maldonado-dark overflow-x-auto">
      <table className="w-full">
        <thead className="bg-maldonado-dark text-white">
          <tr>
            <th className="px-2 sm:px-4 py-3 text-left font-heading hidden sm:table-cell">ORDEN</th>
            <th className="px-2 sm:px-4 py-3 text-left font-heading">IMAGEN</th>
            <th className="px-2 sm:px-4 py-3 text-left font-heading">TÍTULO</th>
            <th className="px-2 sm:px-4 py-3 text-center font-heading hidden md:table-cell">TIPO</th>
            <th className="px-2 sm:px-4 py-3 text-center font-heading hidden lg:table-cell">ACTIVO</th>
            <th className="px-2 sm:px-4 py-3 text-center font-heading">ACCIONES</th>
          </tr>
        </thead>
        <tbody>
          {banners.map((banner, index) => {
            ...
            return (
              ...
              >
                <td className="px-2 sm:px-4 py-3 font-mono text-center hidden sm:table-cell">{banner.order}</td>
                <td className="px-2 sm:px-4 py-3">
                  {banner.image_url ? (
                    <img
                      src={banner.image_url}
                      alt={banner.title}
                      className="w-12 h-12 sm:w-16 sm:h-16 object-contain border border-maldonado-light-gray bg-white"
                    />
                  ) : (
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-maldonado-light-gray flex items-center justify-center">
                      <Image className="w-5 h-5 sm:w-6 sm:h-6 text-maldonado-chrome" />
                    </div>
                  )}
                </td>
                <td className="px-2 sm:px-4 py-3">
                  <span className="font-heading block text-sm sm:text-base">{banner.title}</span>
                  {banner.subtitle && (
                    <span className="text-xs sm:text-sm text-maldonado-chrome">{banner.subtitle}</span>
                  )}
                </td>
                <td className="px-2 sm:px-4 py-3 text-center hidden md:table-cell">
